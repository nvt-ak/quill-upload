...
var ImageHandler = /*#__PURE__*/function (_BaseHandler) {
  function ImageHandler(quill) {
    ...
    _this.customImageClass = options.imageClass || "";
  ...
  return (0, _createClass2["default"])(ImageHandler, [{
    ...
    value: function insertToEditor(url, index) {
      var value = this.customImageClass ? "".concat(url).concat(_utils.Constants.CLASS_SPLIT_FLAG).concat(this.customImageClass) : url;
